        ...
        <main className='flex min-h-[100%] flex-row justify-between relative'>
            <div className='hidden lg:flex items-center justify-center bg-loginBGWhite dark:bg-loginBGDark w-[50%] h-[100%] p-20 bg-no-repeat bg-cover'>
                ...
                >
                    ...
                    <p className='mt-4 2xl:mt-6 text-sm 2xl:text-lg leading-5 2xl:leading-6'>
                        Crie sua conta ou faça login<br></br>
                        para utilizar o <b>Gymn.</b>
                    </p>
                </div>
            </div>
            <div className='bg-loginBGWhite dark:bg-loginBGDark lg:bg-none lg:dark:bg-none w-full flex items-center justify-center lg:w-[50%] h-[calc(100vh-5rem)] mt-[5rem] px-5'>
                <AuthCard />
            </div>
        </main>
    );
