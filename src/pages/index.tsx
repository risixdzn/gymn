...
const Home: NextPage<HomeProps> = ({ switchThemes }) => {
  ...
  return (
    ...
    <>
      ...
      <main className={`flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#2e026d] to-${theme.palette.background}`} color="">
